function viewIndex(){
  var url = 'https://jasonsnider.net/api/posts';
...
function viewPost(postId){
  ...
  var url = 'https://jasonsnider.net/api/posts/view/' + postId;
...
console.log(xhr.response);
    ...
    editPost.addEventListener('submit', function(e){
      ...
      var url = 'https://jasonsnider.net/api/posts/edit';
...
function createPost(){
  ...
  createPost.addEventListener('submit', function(e){
    ...
    var url = 'https://jasonsnider.net/api/posts/create';
...
function deletePost(postId){
  ...
  if (window.confirm("Are you sure you want to delete this post?")) {
    ...
    var url = 'https://jasonsnider.net/api/posts/delete/' + postId;
